...
const APP_TITLE = 'Sprache-zu-Text';

const IS_EMBED = new URLSearchParams(window.location.search).has('embed');

const navigation = [
  { name: 'Übersicht', href: '/', icon: LayoutDashboard },
  { name: 'Startseite', href: '/startseite', icon: FileText },
  { name: 'Audio-Aufnahmen', href: '/audio-aufnahmen', icon: FileText },
  { name: 'Text-Dokumente', href: '/text-dokumente', icon: FileText },
];
